...
require("catppuccin").setup(
    {
        ...
        custom_highlights = function(colors)
            return {
                Normal = {bg = "#E8E2E0", fg = "#4C4C4C"}, -- Set the main background to warm gray and text to neutral dark gray
                Comment = {fg = "#999999", style = "italic"}, -- Muted gray for comments with italic style
                CursorLine = {bg = "#F3ECE7"}, -- Light gray for the current line highlight (transparent background)
                LineNr = {fg = "#A7A9AF"}, -- Muted gray for line numbers to avoid overwhelming the code
                VertSplit = {fg = "#E0DADA"}, -- Subtle light gray for vertical split lines
                StatusLine = {bg = "#F0E4E4", fg = "#4C4C4C"}, -- Status line with warm gray background and readable text
                -- Popup and floating windows
                Pmenu = {bg = "#F0E4E4", fg = "#4C4C4C", blend = 20}, -- Completion menu with slight transparency (blend for opacity)
                PmenuSel = {bg = "#C2E0DF", fg = "#4C4C4C"}, -- Selected item in popup menu with teal highlight
                PmenuSbar = {bg = "#E0DADA"}, -- Popup scrollbar
                PmenuThumb = {bg = "#C2E0DF"}, -- Scroll thumb
                -- Telescope adjustments
                TelescopeNormal = {bg = "NONE", fg = "#4C4C4C"}, -- Preserve transparency in Telescope window
                TelescopeBorder = {fg = "#E0DADA"}, -- Transparent border for Telescope
                TelescopePromptBorder = {fg = "#4E7C78"}, -- Teal border for the prompt section in Telescope
                TelescopeSelection = {bg = "#C2E0DF", fg = "#4C4C4C"}, -- Teal highlight for selected item in Telescope
                TelescopeMatching = {fg = "#4E7C78"}, -- Teal for matched text
                -- Git Signs
                GitSignsAdd = {fg = "#A1C181", bg = "NONE"}, -- Green for added lines (transparent background)
                GitSignsChange = {fg = "#FFDD88", bg = "NONE"}, -- Yellow for changed lines
                GitSignsDelete = {fg = "#E67E80", bg = "NONE"}, -- Soft red for deleted lines
                -- Treesitter Syntax Highlights
                TSFunction = {fg = "#4E7C78"}, -- Teal for function names
                TSString = {fg = "#D4A373"}, -- Soft orange for strings
                TSKeyword = {fg = "#5C92D1"}, -- Soft blue for keywords
                TSConstant = {fg = "#E67E80"}, -- Soft red for constants
                TSVariable = {fg = "#A68ABD"}, -- Muted purple for variables
                -- Other UI elements
                IncSearch = {bg = "#FFDD88", fg = "#4C4C4C"}, -- Search highlight with a soft yellow background
                Search = {bg = "#C2E0DF", fg = "#4C4C4C"}, -- Teal search highlight
                Visual = {bg = "#C2E0DF", fg = "#4C4C4C"}, -- Selection highlight in visual mode
